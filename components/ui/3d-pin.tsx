...
export const PinContainer = ({
  ...
  return (
    <Link
      className={cn(
        "relative group/pin z-50 w-[20rem] cursor-pointer",
        containerClassName
      )}
...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none  w-[5rem] h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
